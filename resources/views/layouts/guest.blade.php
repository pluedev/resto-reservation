...
<body>
    <div class="bg-teal-700 shadow-md" x-data="{ isOpen: false }">
        <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
            <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-white md:text-2xl hover:text-green-400"
                    href="#">
                    Bobito
                </a>
                <!-- Mobile menu button -->
            ...
            <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="text-white font-bold hover:text-green-400"
                    href="/">Home</a>
                <a class="text-white font-bold hover:text-green-400"
