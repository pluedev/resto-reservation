<x-guest-layout>
    ...
    <div
      ...
      style="background-image: url('https://gttp.imgix.net/377388/x/0/filipino-food.jpg?auto=format%2Ccompress&crop=faces%2Cedges%2Ccenter&bg=%23fff&fit=crop&q=35&h=805&dpr=1')">
      <h1
        class="font-mono text-3xl font-extrabold text-transparent text-white md:text-center sm:leading-none lg:text-5xl">
        <span class="inline md:block">Welcome To Bobito Restaurant</span>
      </h1>
      ...
      <div class="flex flex-col items-center mt-12 text-center">
        <span class="relative inline-flex w-full md:w-auto">
          <a href="{{ route('reservations.step-one') }}" type="button"
            class="inline-flex items-center justify-center px-6 py-2 text-base font-bold leading-6 text-white bg-teal-500 rounded-full lg:w-full md:w-auto hover:bg-green-500 focus:outline-none">
        ...
        <div class="flex flex-wrap items-center sm:-mx-3">
          <div class="w-full md:w-1/2 md:px-3">
            ...
            > -->
              ...
              <h2 class="text-4xl text-teal-500">Welcome</h2>
              <!-- </h1> -->
              ...
              <div class="relative flex">
                <a href="#_"
                  class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-teal-500 rounded-md sm:mb-0 hover:bg-green-700 sm:w-auto">
                  Read More
    ...
    <section class="mt-8 bg-white">
      <div class="mt-4 text-center">
        ...
        <h2 class="text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
          TODAY'S SILOG MEALS</h2>
      </div>
      <div class="container w-full px-5 py-6 mx-auto">
        <div class="grid lg:grid-cols-4 gap-y-6">
          @foreach ($silogs->menus as $menu)
          <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
            <img class="w-full h-48" src="{{ Storage::url($menu->image) }}"
              alt="Image" />
            <div class="px-6 py-4">
              <div class="flex mb-2">
                <span class="px-4 py-0.5 text-sm bg-red-500 rounded-full text-red-50">{{ $silogs->name }}</span>
              </div>
